...
var assetsFetchEpic = function (action$, state$) {
    return action$.pipe(operators_1.filter(exports.assetsActions.fetchRequest.match), operators_1.withLatestFrom(state$), operators_1.switchMap(function (_a) {
        ...
        return rxjs_1.of(action).pipe(debugThrottle_1.default(state.debug.badConnection), operators_1.mergeMap(function () { return client_1.client.observable.fetch(query, params); }), operators_1.mergeMap(function (result) {
